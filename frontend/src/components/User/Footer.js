               ...
               <div className="row">
                  <div className=" col-md-4">
                     ...
                     <ul className="conta">
                        ...
                        <li> <i className="fa fa-envelope" aria-hidden="true"></i><Link href="#"> demo@gmail.com</Link></li>
                     </ul>
                  </div>
                  <div className="col-md-4">
                     <h3>Menu Link</h3>
                     <ul className="link_menu">
                        ...
                        <li><Link href="room.html">Our Room</Link></li>
               ...
               <div className="container">
                  <div className="row">
                     <div className="col-md-10 offset-md-1">
                        ...
                        <p>
                        © 2019 All Rights Reserved. Design by <Link href="https://html.design/"> Free Html Templates</Link>
                        <br/><br/>
