            ...
            <div className="row">
               ...
               <div className="col-md-6">
                  <div className="map_main">
                     ...
                     <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=Eiffel+Tower+Paris+France"  width="600" height="400" frameBorder="0" style={{ border: 0, width: '100%' }} allowFullScreen="" title='/'></iframe>
                     </div>
                  </div>
               </div>
            </div>
